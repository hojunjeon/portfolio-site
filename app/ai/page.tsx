  ...
  return (
    <header className={`${styles.projectHeader}${dark ? ` ${styles.projectHeaderDark}` : ""}`}>
      ...
      <div>
        ...
        <ProjectFacts period={period} form={form} roleText={roleDescription} />
      </div>
    </header>
  );
}
...
function MediaFigure({ asset, dark = false, className = "" }: { asset: MediaAsset; dark?: boolean; className?: string }) {
  return (
    <figure className={`primary-media ${styles.mediaFigure}${dark ? ` ${styles.mediaFigureDark}` : ""}${className ? ` ${className}` : ""}`}>
...
function KeywordRail({ title, keywords, dark = false }: { title: string; keywords: string[]; dark?: boolean }) {
  return (
    <div className={`${styles.keywordRail}${dark ? ` ${styles.keywordRailDark}` : ""}`}>
      <span>{title}</span>
      <ul className={styles.keywordList} aria-label={`${title} 기술 키워드`}>
          ...
          <div className={styles.detailInner}>
            <div className={styles.projectIntroduction}>
              <ProjectHeader
                ...
                period="2026.05"
                form="SSAFY 관통 프로젝트(팀)"
                roleDescription="백엔드·AI 서버(LLM·GraphRAG)"
              />
            ...
            <div className={styles.projectDevelopment} data-story-type="troubleshooting">
              ...
              <KeywordRail title="기술 구성" keywords={["FastAPI", "GraphRAG", "LLM pipeline", "Django REST Framework", "Vue.js", "SQL", "Playwright"]} />
          ...
          <div className={styles.detailInner}>
            <div className={styles.projectIntroduction}>
              <ProjectHeader
                ...
                period="2026.05"
                form="SSAFY×Kakao AI 해커톤(팀)"
                roleDescription="정보 추출 엔진 설계 및 테스트"
              />
            ...
            <div className={styles.projectDevelopment} data-story-type="reframing">
              ...
              <KeywordRail title="기술 구성" keywords={["LLM", "STT", "JSON Schema", "Orchestrator", "Extractor", "Verifier", "Dashboard"]} />
            </div>
          </div>
        </section>
        ...
        <section id="hermes" className={`page-body-section surface-dark ${styles.projectSection} ${styles.darkSection}`} aria-labelledby="hermes-title">
          <div className={styles.detailInner}>
            ...
            <div className={styles.projectDevelopment} data-story-type="operations">
              ...
              <KeywordRail dark title="운영 구성" keywords={["Hermes Agent", "Telegram Bot", "Oracle Cloud", "Kanban", "Honcho", "cron", "n8n", "Notion"]} />
            </div>
          </div>
        </section>
          ...
          <div className={styles.detailInner}>
            <div className={styles.projectIntroduction}>
              <ProjectHeader
                ...
                period="2025.05"
                form="팀 프로젝트"
                roleDescription="모델 아키텍처 설계·데이터 전처리 파이프라인"
              />
            ...
            <div className={styles.projectDevelopment} data-story-type="judgment-split">
              ...
              <KeywordRail title="기술 구성" keywords={["SegFormer", "YOLOv11", "YOLOv8-seg", "OpenCV", "Python", "AIHub dataset"]} />
            </div>
          </div>
        </section>
